            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
              ...
              >
               <p className="text-6xl font-palyfair z-10 text-center md:text-start">
                ...
                before:absolute before:-left-[25px] before:-top-[70px] before:z-[-1]">Esper</span>
               </p>
               <p className="mt-10 mb-7 text-sm text-center md:text-start">Adipiscing arcu, in aliquam fringilla cursus. Elit arcu elementum viverra malesuada sem ac 
