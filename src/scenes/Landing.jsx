...
const Landing = ({setSelectedPage}) => {
    ...
    return(
        <section id="home" className="md:flex md:justify-between md:item-center md:w-full gap-16 py-10">
            {/* IMAGE SECTION*/}

            <div className="md:order-2 flex justify-center basic-3/5 z-10 mt-16 md:mt-22">
            {isAboveMediumScreens ? (
                ...
                before:w-full before:max-w-[400px] before:h-full before:border-2 before:border-blue before:z-[-1]">
                    <img src="../assets/profile-image.png" alt="profile" className="hover:filter hover:saturate-200 transition 
