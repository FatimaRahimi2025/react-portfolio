             ...
             <div className="md:flex md:justify-between mt-16 gap-32">
                ...
                >
                    <div className="relative h-32">
                        ...
                        <p className="mt-5">
                            A auctor pharetran hendrerit mattis amet etiam interdum platea. Est morbi porttitor
                            scelerisque fermentum, sagittis non egestas. Amet odio sit Sagittis,
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    <div className="relative h-32">
                        ...
                        <p className="mt-5">
                            Urna, eget pulvinar dolor cursus volutpat dictum odio, Nec ultricies amet in in 
                            neque nibh tortor. Libero sed pretium justo nulla blandit nulla amet habitant 
                            iaculis. Iaculis in congue vitae sollicitudin faucibus a
                        </p>
                    </div>
                </motion.div>
